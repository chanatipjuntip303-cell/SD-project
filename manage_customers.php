...
<div class="container">
    ...
    <div class="card" style="margin-top: 30px; border-top: 4px solid #ef4444;">
        <h3 style="color: #ef4444;">Recycle Bin (Deleted Customers)</h3>
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?restore_id=<?php echo $t['customer_id']; ?>" class="btn btn-success" style="font-size:0.8em;">Restore</a>
